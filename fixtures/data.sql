...
VALUES 
-- Bosch Product
('product', '00000000-0000-0000-0000-000000000001', 'en', 'product_name', 'Bosch Synthetic Oil 5W-30'),
('product', '00000000-0000-0000-0000-000000000001', 'th', 'product_name', 'น้ำมันเครื่อง บ๊อช ซินเธติก'),
-- Castrol Product
('product', '00000000-0000-0000-0000-000000000002', 'en', 'product_name', 'Castrol Magnatec 10W-40'),
('product', '00000000-0000-0000-0000-000000000002', 'th', 'product_name', 'น้ำมันเครื่อง คาสตรอล แมกนาเทค'),
-- Mobil1 Product
('product', '00000000-0000-0000-0000-000000000003', 'en', 'product_name', 'Mobil1 Full Synthetic 5L'),
('product', '00000000-0000-0000-0000-000000000003', 'th', 'product_name', 'น้ำมันเครื่อง โมบิลวัน');
